 ...
 * </p>
 * <ul>
 *   <li>{@link ma.ensias.bpmn.impl.ActivityImpl#getId <em>Id</em>}</li>
 *   <li>{@link ma.ensias.bpmn.impl.ActivityImpl#getName <em>Name</em>}</li>
 *   <li>{@link ma.ensias.bpmn.impl.ActivityImpl#getTo <em>To</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ActivityImpl extends MinimalEObjectImpl.Container implements Activity {
	 ...
	 * @ordered
	 */
	protected EList<MessageFlow> to;
	 ...
	 * @generated
	 */
	public EList<MessageFlow> getTo() {
		if (to == null) {
			to = new EObjectResolvingEList<MessageFlow>(MessageFlow.class, this, BpmnPackage.ACTIVITY__TO);
		}
		return to;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case BpmnPackage.ACTIVITY__TO:
			getTo().clear();
			getTo().addAll((Collection<? extends MessageFlow>) newValue);
			return;
		}
