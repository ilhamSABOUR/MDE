 ...
 * </p>
 * <ul>
 *   <li>{@link ma.ensias.bpmn.impl.SubProcessImpl#getRef_SubProcess <em>Ref Sub Process</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubProcessImpl extends ProcessImpl implements SubProcess {
	 ...
	 * @ordered
	 */
	protected EList<ma.ensias.bpmn.Process> ref_SubProcess;
	 ...
	 * @generated
	 */
	public EList<ma.ensias.bpmn.Process> getRef_SubProcess() {
		if (ref_SubProcess == null) {
			ref_SubProcess = new EObjectContainmentEList<ma.ensias.bpmn.Process>(ma.ensias.bpmn.Process.class, this,
					BpmnPackage.SUB_PROCESS__REF_SUB_PROCESS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case BpmnPackage.SUB_PROCESS__REF_SUB_PROCESS:
			...
			getRef_SubProcess().addAll((Collection<? extends ma.ensias.bpmn.Process>) newValue);
			return;
		}
