 ...
 * </p>
 * <ul>
 *   <li>{@link ma.ensias.bpmn.impl.EventImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventImpl extends ActivityImpl implements Event {
	 ...
	 * @ordered
	 */
	protected static final EventType TYPE_EDEFAULT = EventType.START;
	...
	public void setType(EventType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BpmnPackage.EVENT__TYPE, oldType, type));
	}
