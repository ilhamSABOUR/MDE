...
public class PoolItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BpmnPackage.Literals.POOL__ACTIVITY);
			childrenFeatures.add(BpmnPackage.Literals.POOL__FLOWOBJECT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BpmnPackage.Literals.POOL__ACTIVITY,
				 BpmnFactory.eINSTANCE.createEvent()));

		newChildDescriptors.add
			(createChildParameter
				(BpmnPackage.Literals.POOL__ACTIVITY,
				 BpmnFactory.eINSTANCE.createSplit()));

		newChildDescriptors.add
			(createChildParameter
				(BpmnPackage.Literals.POOL__ACTIVITY,
				 BpmnFactory.eINSTANCE.createParallel()));

		newChildDescriptors.add
			(createChildParameter
				(BpmnPackage.Literals.POOL__ACTIVITY,
				 BpmnFactory.eINSTANCE.createOR()));

		newChildDescriptors.add
			(createChildParameter
				(BpmnPackage.Literals.POOL__ACTIVITY,
				 BpmnFactory.eINSTANCE.createXOR()));

		newChildDescriptors.add
			(createChildParameter
				(BpmnPackage.Literals.POOL__ACTIVITY,
				 BpmnFactory.eINSTANCE.createJoin()));
		...
		newChildDescriptors.add
			(createChildParameter
				(BpmnPackage.Literals.POOL__FLOWOBJECT,
