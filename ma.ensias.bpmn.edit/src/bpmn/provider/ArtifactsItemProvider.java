...
/**
 * This is the item provider adapter for a {@link bpmn.Artifacts} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactsItemProvider 
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artifacts_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artifacts_type_feature", "_UI_Artifacts_type"),
				 BpmnPackage.Literals.ARTIFACTS__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Artifacts.class)) {
			case BpmnPackage.ARTIFACTS__ID:
			case BpmnPackage.ARTIFACTS__NAME:
			case BpmnPackage.ARTIFACTS__TYPE:
