 ...
 * @generated
 */
public class SequenceFlowItemProvider extends FlowObjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SequenceFlow_to_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SequenceFlow_to_feature", "_UI_SequenceFlow_type"),
				 BpmnPackage.Literals.SEQUENCE_FLOW__TO,
				 true,
				 false,
				 true,
				 null,
