...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>userStory</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class UserStoryExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(UserStoryPackage.eNS_URI, 
			 UserStoryPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				...
				Backlog root = UserStoryFactory.eINSTANCE.createBacklog();
